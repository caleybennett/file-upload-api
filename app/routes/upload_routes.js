...
router.get('/upload', requireToken, (req, res, next) => {
  Upload.find()
    ...
    // respond with status 200 and JSON of the upload
...
// UPDATE
// PATCH /upload/5a7db6c74d55bc51bdf39793
router.patch('/upload/:id', requireToken, removeBlanks, (req, res, next) => {
...
// DESTROY
// DELETE /upload/5a7db6c74d55bc51bdf39793
router.delete('/upload/:id', requireToken, (req, res, next) => {
  Upload.findById(req.params.id)
    .then(handle404)
    .then(upload => {
